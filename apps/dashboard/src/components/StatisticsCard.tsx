...
const StatisticsCard = ({ statistics }: StatisticsCardProps) => {
	...
	return (
		<div className="statistics-card-background flex flex-col justify-between rounded-3xl border pb-12 pl-8 pr-6 pt-10 tracking-wide shadow-sm lg:flex-row lg:pl-12">
